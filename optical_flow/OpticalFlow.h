...
public:
	...
	//subarna
	static void Coarse2FineTwoFrames(DImage& Im1, DImage& Im2, DImage **vx, DImage **vy, 
					double alpha, double ratio, int minWidth, int nOuterFPIterations, int nInnerFPIterations, int nSORIterations);
	/*static DImage* Coarse2FineTwoFrames(DImage& Im1, DImage& Im2, 
					double alpha, double ratio, int minWidth, int nOuterFPIterations, int nInnerFPIterations, int nSORIterations);*/
...
void OpticalFlow::Coarse2FineTwoFrames(DImage &Im1, DImage &Im2, DImage **vx, DImage **vy, double alpha, double ratio, int minWidth, int nOuterFPIterations, int nInnerFPIterations, int nSORIterations)
//DImage* OpticalFlow::Coarse2FineTwoFrames(DImage &Im1, DImage &Im2, double alpha, double ratio, int minWidth, int nOuterFPIterations, int nInnerFPIterations, int nSORIterations)
{		
	...
	DImage vx_1, vy_1;
	DImage warpI2;
	OpticalFlow::Coarse2FineFlow(vx_1, vy_1, warpI2, Im1,Im2,alpha,ratio,minWidth,nOuterFPIterations,nInnerFPIterations,nSORIterations);
...
bool OpticalFlow::showFlow(const DImage& flow,const char* filename)
{
	...
	double Max = flow.m_max();
	double Min = flow.m_min();
	for(int i = 0;i<flow.npixels(); i++)
