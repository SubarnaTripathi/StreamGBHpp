...
public:
	...
	*/
	...
	template <class T1>
	void BilateralFiltering(Image<T1>& other,int fsize,double filter_signa,double range_sigma, int height, int width);

	// function to bilateral smooth an image
	//Image<T> BilateralFiltering(int fsize,double filter_sigma,double range_sigma);
	void imBilateralFiltering(Image<T>& result,int fsize,double filter_sigma,double range_sigma, int height, int width);
...
template <class T>
template <class T1>
void Image<T>::BilateralFiltering(Image<T1>& other,int fsize,double filter_sigma,double range_sigma, int height, int width)
{
	double *pBuffer;
...
template <class T>
//Image<T>  Image<T>::BilateralFiltering(int fsize,double filter_sigma,double range_sigma,int height, int width)
void  Image<T>::imBilateralFiltering(Image<T>& result,int fsize,double filter_sigma,double range_sigma, int height, int width)
{
	//Image<T> result(*this);
...
//subarna: rename member functions
template <class T>
T Image<T>::m_max() const
{
	T Max = pData[0];
	for(int i = 0;i<nElements; i++)
		Max = __max(Max,pData[i]);
