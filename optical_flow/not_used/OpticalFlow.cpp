...
void OpticalFlow::Coarse2FineTwoFrames(DImage &Im1, DImage &Im2, DImage &warpI2, double alpha, double ratio, int minWidth, int nOuterFPIterations, int nInnerFPIterations, int nSORIterations)
{		
	//subarna
	//DImage Im1,Im2;
